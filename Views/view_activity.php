                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6" style="align-self: center;">
                                                ...
                                                <?php if ($array[$i]['actividades'][$x]['anexo']!= "") {
                                                    if ($_POST['response']['depto'] == 2) {
                                                        $is_chk2 = "";
                                                    }
                                                ?>
                                                    <button type="button" id="verAnexo-<?=$array[$i]['actividades'][$x]['anexo'];?>"  class="btn btn-primary btn-sm ms-3 mt-2 verAnexo568" <?=$is_chk2;?>>Ir a <?=$array[$i]['actividades'][$x]['nom_anexo'];?></button>
